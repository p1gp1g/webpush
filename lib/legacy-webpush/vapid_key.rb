module LegacyWebpush
  ...
  class VapidKey
    ...
    #
    # @return [LegacyWebpush::VapidKey] a VapidKey instance for the given public and private keys
    ...
    def to_big_num(key)
      OpenSSL::BN.new(LegacyWebpush.decode64(key), 2)
    end

    def encode64(bin)
      LegacyWebpush.encode64(bin)
    end
